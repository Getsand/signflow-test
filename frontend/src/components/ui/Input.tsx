...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    // Base input styles
    const baseStyles = 'block px-4 py-2.5 text-base rounded-lg border transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2';
